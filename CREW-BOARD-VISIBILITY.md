...
**Purpose:** Single source of truth for all estate decisions, P1 fires, and agent handoffs. If a broadcast fails to land here, it is dead-lettered to `~/.claude/state/board-deadletter.jsonl`.
