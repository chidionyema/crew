...
**Purpose:** Single source of truth for all estate decisions, P1 fires, and agent handoffs. Failed broadcasts are logged to `~/.claude/state/board-deadletter.jsonl`.
