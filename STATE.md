...
**Generated 2026-09-01 17:05 UTC** by `scripts/estate-snapshot`. Every row is a command and its
...
| maestro | GREEN | last cycle 8 min ago (`INTENT-20260901-165358-0d20f3e7.json`) |
...
| revenue | NOT RUN | last measurement 2026-08-28T12:37:36Z is 101h old (bar 24h) |
| ci runs | NOT RUN | last measurement 2026-08-27T03:28:24Z is 134h old (bar 30h) |
| delivery | RED | 782 commits on no remote (oldest 10.3d), 22 dirty files, 7 live repos (`git log --branches --not --remotes`) |
| &nbsp;&nbsp;shipped | >=1000 merged | non-bot PRs merged across the estate in 7d (`gh search prs`) |
| &nbsp;&nbsp;stranded | .wt-cg-656 | 351 commits no remote holds, oldest 9.1d, 0 dirty |
| &nbsp;&nbsp;stranded | .crew-state | 287 commits no remote holds, oldest 10.3d, 3 dirty |
| &nbsp;&nbsp;stranded | .wt-estate-656 | 85 commits no remote holds, oldest 7.9d, 0 dirty |
| founder cost | NOT RUN | `attention_daily` did not answer |
| live checkout | RED | `main` has diverged from origin/main; not moved |
...
| science plane: warehouse | RED | DuckDB+dbt, 0 dbt model(s), rebuilt 192h ago (`science/warehouse.db`) |
...
| hooks | GREEN | 35358 runs in 24h, 318 refused (most: rule-guard.py 101), slowest 120389 ms, 54 overturned by a marker (`hook-outcomes.jsonl`) |
...
| portability | GREEN | ready 11/43 (root-red 2 all named, cascaded 27, pending 3) on a cluster with no OCI (floor 10); the cascade waits 22 on secret-store, 3 on observability, 2 on prospector-platform (idp run 33265235988, 72.0h ago (bar 194h)) |
