...
**Generated 2026-08-24 09:19 UTC** by `scripts/estate-snapshot`. Every row is a command and its
...
| maestro | GREEN | last cycle 0 min ago (`INTENT-20260824-091341-0d20f3e7.json`) |
...
| delivery | RED | 79 commits on no remote (oldest 2.0d), 58 dirty files, 8 live repos (`git log --branches --not --remotes`) |
| &nbsp;&nbsp;shipped | 324 merged | non-bot PRs merged across the estate in 7d, ~$18 of estate spend per shipped change (`gh search prs`) |
| &nbsp;&nbsp;stranded | crew | 61 commits no remote holds, oldest 2.0d, 4 dirty |
| &nbsp;&nbsp;stranded | scripts | 17 commits no remote holds, oldest 0.7d, 17 dirty |
