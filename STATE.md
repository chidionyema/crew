...
**Generated 2026-09-08 13:03 UTC** by `scripts/estate-snapshot`. Every row is a command and its
...
|---|---|---|
| The Architect | GREEN | `bin/verify`: PASS  dispatch claims agent-go and never icebox 3 passed in 3.52s |
...
| estate board | GREEN | estate-board-sync: 215 row(s) from chidionyema/crew#102 -> /Users/chidionyema/.claude/ESTATE_BOARD.jsonl |
| maestro | STALE | last cycle 112 min ago (`INTENT-20260908-111208-0d20f3e7.json`) |
...
| revenue | NOT RUN | last measurement 2026-08-28T12:37:36Z is 264h old (bar 24h) |
| ci runs | NOT RUN | last measurement 2026-08-27T03:28:24Z is 298h old (bar 30h) |
| delivery | RED | 634 commits on no remote (oldest 15.9d), 52 dirty files, 10 live repos (`git log --branches --not --remotes`) |
| &nbsp;&nbsp;shipped | >=1000 merged | non-bot PRs merged across the estate in 7d (`gh search prs`) |
| &nbsp;&nbsp;stranded | .wt-cg-656 | 357 commits no remote holds, oldest 15.9d, 0 dirty |
| &nbsp;&nbsp;stranded | idp | 241 commits no remote holds, oldest 5.1d, 18 dirty |
| &nbsp;&nbsp;stranded | .wt-estate-656 | 11 commits no remote holds, oldest 14.7d, 0 dirty |
| founder cost | NOT RUN | `attention_daily` did not answer |
| live checkout | GREEN | moved 1 commit(s) to origin/main 60fa27d, 4 local edit(s) kept |
...
| science plane: warehouse | RED | DuckDB+dbt, 0 dbt model(s), rebuilt 355h ago (`science/warehouse.db`) |
...
| hooks | GREEN | 41603 runs in 24h, 303 refused (most: rule-guard.py 134), slowest 25508 ms, 20 overturned by a marker (`hook-outcomes.jsonl`) |
...
| portability | RED | ready 11/43 (root-red 2 all named, cascaded 27, pending 3) on a cluster with no OCI (floor 10); the cascade waits 22 on secret-store, 3 on observability, 2 on prospector-platform (idp run 33265235988, 235.8h ago (bar 194h)) |
...
| OKE flux | RED | 9 of 82 Kustomizations not ready: chaos, commerce, gvisor-runtime, nodesoftware-operator, otto-gateway, prospector, scheduling, temporal, To |
