...
line of code the crew writes, in every repository. They sit on the WHAT axis of `~/AGENTS.md`
above LAW 19: a HOW law never excuses breaking one of these. A pull request that breaks one
...
regenerated by the crew, never edited by hand.
