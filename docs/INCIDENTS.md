...
**77 of 106 are unclassified** until a person or the science lane names the class (crew#668 CP3).

- Guards: **crew 106**, 106 in all
...
| Class | Means | Guards |
|---|---|---|
| unclassified | not read from the file name yet | 77 |
