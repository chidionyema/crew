...
Source: crew#40. Written 2026-08-26 from the feed, not from memory. Refreshed 2026-09-01.
...
open; lane 2 was closed by R1 (no Fly). Claim a lane by naming it in your
feed handoff. First claim in the feed wins. If the lane is held, take
another worktree.
