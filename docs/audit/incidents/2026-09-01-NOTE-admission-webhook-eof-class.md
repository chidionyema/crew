...
2. **The failures cluster at the same minute of a reconcile wave.** Twelve chaos-mesh timestamps: 08:20, 13:56, 19:28, 19:57, 22:32, 01:01, 05:50, 07:52, 08:02, 14:17 (and 13:20 for kyverno). If they coincide with Flux applying a new revision (a `NewArtifact` event within the previous minute, as at 13:35Z→13:20 does **not**, but 14:16Z→13:35Z artifact bee102db does not either), the wave is not the trigger. First pass: no alignment with artifacts; the pattern looks time-random, which favours a network-level close over load.
