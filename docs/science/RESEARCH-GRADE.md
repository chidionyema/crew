...
Generated 2026-09-09 by `python3 science/research_grade.py`. Two directions, graded separately (R37): **Outward** is what the estate learned from the world, **Inward** is what it learned about itself. Every row re-runs; no number is typed by hand.
...
| What | Value | How it is counted |
|---|---|---|
| Last pull | 2026-08-30T03:29:58+00:00 (RED, 10.1d ago) | `science/research-intake-state.json` `last_pull`, red past 2 days |
...
|---|---|---|---|
| RED 10d | Secrets | [FiloSottile/age v1.3.2](https://github.com/FiloSottile/age/releases/tag/v1.3.2) | - |
| RED 10d | Agent traces | [langfuse/langfuse v4.24.0](https://github.com/langfuse/langfuse/releases/tag/v4.24.0) | - |
| RED 10d | Scheduling | [dagster-io/dagster 1.13.20](https://github.com/dagster-io/dagster/releases/tag/1.13.20) | - |
| RED 10d | Code quality | [astral-sh/ruff 0.16.5](https://github.com/astral-sh/ruff/releases/tag/0.16.5) | - |
