...
Generated 2026-09-13 by `python3 science/research_grade.py`. Two directions, graded separately (R37): **Outward** is what the estate learned from the world, **Inward** is what it learned about itself. Every row re-runs; no number is typed by hand.
...
| What | Value | How it is counted |
|---|---|---|
| Last pull | 2026-08-30T03:29:58+00:00 (RED, 13.9d ago) | `science/research-intake-state.json` `last_pull`, red past 2 days |
