...
|---|---:|---:|---|---|
| code | 422,169 | 0 | GAP | ships, ci_runs, ci_reach, bundle_push, estate_push, worktree_cleanup, hook_outcomes, close_guard, dora |
| crew | 56,953 | 0 | GAP | board, ledger, decisions, directives, tickets, goal_net, attention, founder_actions, board_deadletter, prompt_ledger |
| data-ml | 48,113 | 0 | GAP | dagster-ticks, dagster-runs, temporal_dev_executions, job_timelines |
| hermes-v2 | 9,726 | 0 | GAP | alerts_inbox, sovereign_receipts, sovereign_budget, revenue, agent_cert, runaway-reaper, stuck_detector, aiden_ticks |
| portal | 25,923 | 0 | GAP | estate_registry, capability_receipts, enforcement_map, drills, drills_scripts |
| science | 19,947 | 0 | GAP | research_ledger, predictions, method_metrics, history, spend |
| unmapped | 87 | 0 | GAP | hindsight_recall, pi_bridge_runs |

- BLIND: none
- sources in no lane: hindsight_recall (80), pi_bridge_runs (7) — add them to LANE_SOURCES in science/showcase.py
...
- 60 register entries (COLLECTED 35, EXCLUDED 9, NEVER_EMITTED 4, WIRED_NEVER 11, WRITER_DEAD 1); 4974 producers discovered at the last census
...
|---|---|---|---|---|---|---:|---:|---|
| bundle_push | code | `~/.claude/state/estate-bundle-push.jsonl` | `~/.claude/scripts/estate/estate_bundle_push.sh` | poll | internal | 180 | 48 | 2026-08-31T09:30:43+00:00 |
| ci_reach | code | `~/.claude/state/ci-reach.jsonl` | `~/.claude/scripts/estate/estate_audit.py` | poll | internal | 180 | 48 | 2026-08-31T06:21:12Z |
| ci_runs | code | `science/ci-runs.jsonl` | `science/outcomes.py` | poll | internal | 365 | 30 | 2026-08-27T03:28:24Z |
| close_guard | code | `~/.claude/state/close-guard-observe.jsonl` | `~/.claude/scripts/close-guard.py` | push | internal | 90 | 48 | 2026-08-31T12:34:29Z |
| dora | code | `science/dora.jsonl` | `scripts/science-collect` | poll | internal | 3650 | 26 | 2026-08-31T12:37:16Z |
| estate_push | code | `~/.claude/state/estate-push.jsonl` | `~/.claude/scripts/estate/estate_push.sh` | poll | internal | 180 | 48 | 2026-08-28T15:19:15+00:00 |
| hook_outcomes | code | `~/.claude/state/hook-outcomes.jsonl` | `~/.claude/scripts/hook-run.py` | push | internal | 180 | 24 | 2026-08-31T12:38:07Z |
| lane.code.pr-hygiene | code | `science/pr-hygiene.jsonl` | `science/outcomes.py` | poll | internal | 365 | 30 | 2026-08-27T14:21:25Z |
| ships | code | `science/ships.jsonl` | `scripts/science-collect` | poll | internal | 3650 | 26 | 2026-08-31T12:37:11+00:00 |
| worktree_cleanup | code | `~/.claude/state/estate-worktree-cleanup.jsonl` | `~/.claude/scripts/estate/estate_worktree_cleanup.sh` | poll | internal | 180 | 720 | 2026-08-23T13:27:48Z |
| attention | crew | `science/attention.jsonl` | `science/outcomes.py` | poll | restricted | 365 | 26 | 2026-08-31T12:37:16+00:00 |
| board | crew | `~/.claude/ESTATE_BOARD.jsonl` | `~/.claude/scripts/board-deliver.py` | push | internal | 365 | 48 | 2026-08-31T11:44:11Z |
| board_deadletter | crew | `~/.claude/state/board-deadletter.jsonl` | `~/.claude/scripts/estate-broadcast.py` | push | internal | 90 | 48 | 2026-08-26T16:33:00.425345Z |
| decisions | crew | `~/.claude/DECISIONS.jsonl` | `scripts/science-collect` | poll | internal | 3650 | 48 | 2026-08-31T10:30:43Z |
| directives | crew | `~/.claude/directives` | `~/.claude/scripts/directives.py` | push | restricted | 3650 | 48 | 2026-08-31T12:35:30+00:00 |
| founder_actions | crew | `~/.claude/state/founder-actions.jsonl` | `~/.claude/scripts/founder_actions.py` | push | internal | 3650 | 720 | 2026-08-26 |
| goal_net | crew | `~/.claude/state/goal-net.jsonl` | `~/.claude/scripts/goal_graph.py` | push | internal | 180 | 48 | 2026-08-31T11:44:09+00:00 |
| ledger | crew | `~/.claude/state/ledger.jsonl` | `~/.claude/scripts/goal-guard.py` | push | internal | 180 | 48 | 2026-08-31T11:17:29Z |
| prompt_ledger | crew | `~/.claude/state/prompt-ledger` | `~/.claude/scripts/prompt-ledger.py` | push | restricted | 365 | 48 | 2026-08-31T12:31:24.566Z |
| tickets | crew | `~/.claude/state/tickets` | `~/.claude/scripts/aiden/aiden.py` | push | internal | 365 | 48 | - |
| dagster-runs | data-ml | `$ESTATE_CODE/idp/run/dagster/history/runs.db` | `~/dev/code/idp/bin/scheduler-up` | poll | internal | 90 | 24 | 2026-08-31 12:37:05.960182+00:00 |
| dagster-ticks | data-ml | `$ESTATE_CODE/idp/run/dagster/schedules/schedules.db` | `~/dev/code/idp/bin/scheduler-up` | poll | internal | 90 | 2 | 2026-08-31 12:38:19.735978+00:00 |
| job_timelines | data-ml | `~/.claude/jobs` | `scripts/admit` | push | internal | 90 | 48 | 2026-08-30T01:13:29.233Z |
| temporal_dev_executions | data-ml | `~/.estate/temporal/dev.db` | `~/.claude/scripts/launchagents/ai.estate.temporal.plist` | poll | internal | 90 | 48 | 2026-08-26 03:57:51.383855+00:00 |
| agent_cert | hermes-v2 | `~/.claude/agent-cert/history.jsonl` | `~/.claude/scripts/statusline-context.py` | push | internal | 180 | 48 | 2026-08-31T11:14:46Z |
| aiden_ticks | hermes-v2 | `~/.claude/state/aiden-ticks.jsonl` | `~/.claude/scripts/aiden/tick.py` | poll | internal | 90 | 48 | 2026-08-27T18:16:17Z |
| alerts_inbox | hermes-v2 | `~/.estate/alerts/inbox.jsonl` | `~/.claude/scripts/founder-deliver.py` | push | internal | 180 | 6 | 2026-08-31T12:00:56+00:00 |
| revenue | hermes-v2 | `science/revenue.jsonl` | `science/outcomes.py` | hand | restricted | 3650 | 24 | 2026-08-31T12:37:47Z |
| runaway-reaper | hermes-v2 | `~/.estate/logs/maintenance/runaway-reaper.jsonl` | `~/.claude/scripts/estate/runaway-reaper.sh` | poll | internal | 90 | 168 | 2026-08-27T03:14:57Z |
| sovereign_budget | hermes-v2 | `~/.estate/sovereign/budget.db` | `~/dev/code/idp/sovereign/engine/budget.py` | push | internal | 30 | 48 | - |
| sovereign_receipts | hermes-v2 | `~/.estate/sovereign/receipts.jsonl` | `~/.claude/scripts/estate/launchd_receipt.py` | poll | internal | 365 | 48 | 2026-08-26T03:57:53.788265+00:00 |
| stuck_detector | hermes-v2 | `~/.claude/state/logs/stuck-detector.jsonl` | `~/.claude/scripts/stuck_detector_tick.sh` | poll | internal | 30 | 48 | 2026-08-27T06:35:40Z |
| capability_receipts | portal | `~/.estate/state/capability_receipts.jsonl` | `~/.claude/scripts/estate/launchd_receipt.py` | push | internal | 365 | 48 | 2026-08-31T12:30:04+00:00 |
| drills | portal | `~/.claude/state/drills.jsonl` | `~/.claude/scripts/drills/run.py` | poll | internal | 365 | 48 | 2026-08-31T05:49:33+00:00 |
| drills_scripts | portal | `~/.claude/scripts/state/drills.jsonl` | `~/.claude/scripts/drills/run.py` | poll | internal | 365 | 48 | 2026-08-27T05:50:47+00:00 |
| enforcement_map | portal | `science/enforcement-map.json` | `science/law_enforcement.py` | poll | internal | 365 | 48 | - |
| estate_registry | portal | `~/.estate/registry.jsonl` | `~/.estate/registry.jsonl` | hand | internal | 3650 | 48 | 2026-08-25T18:29:58.248160+00:00 |
| history | science | `~/.claude/history.jsonl` | `~/.claude/scripts/secret-scrub.py` | push | restricted | 365 | 48 | 2026-08-31T12:36:11+00:00 |
| method_metrics | science | `~/Documents/code/prospector/store/ops/method_metrics.json` | `~/.claude/scripts/reflect.py` | poll | internal | 180 | 12 | 2026-08-31T10:09:51+00:00 |
| predictions | science | `science/predictions.jsonl` | `science/outcomes.py` | hand | internal | 3650 | 48 | 2026-08-30T12:54:39+00:00 |
| research_ledger | science | `science/RESEARCH-LEDGER.jsonl` | `science/ledger.py` | hand | internal | 3650 | 168 | 2026-08-27 |
| spend | science | `~/.claude/estate-spend-history.jsonl` | `~/.claude/scripts/estate/estate_cost_sentinel.py` | poll | internal | 365 | 6 | 2026-08-31T13:00:56 |
| hindsight_recall | unmapped | `~/.claude/hindsight-recall-history.jsonl` | `~/.claude/settings.json` | push | internal | 180 | 24 | 2026-08-28T09:00:41Z |
| pi_bridge_runs | unmapped | `~/.claude/state/pi-bridge-runs.jsonl` | `~/.claude/mcp/pi_bridge.py` | push | internal | 365 | 48 | 2026-08-31T00:28:33Z |
...
- spend USD 10032.69, USD per commit 30.22
...
- trained 2026-08-31T13:10Z on 2107 labelled PRs; 33% of first runs were red
- unseen newest 422 PRs: accuracy 71% against a base rate of 64%; Brier 0.185
- model beats the base rate on unseen PRs
- strongest signals: log_files (+0.52), r_crew (+0.48), r_prospector (-0.32), log_del (-0.26), log_add (+0.25)
