...
Generated 2026-09-02T19:03Z by `python3 science/showcase.py`. Every number is read at generation
...
Previous run: 2026-09-02T06:46Z.

- foresight labelled PRs: 2126 -> 2130
- foresight holdout accuracy: 0.728 -> 0.69
- warehouse rows: 674201 -> 693616
- commits, 7d: 236 -> 254
- complaints, 7d: 329 -> 342
- spend USD, 7d: 8956.85 -> 9250.05
- USD per commit: 37.95 -> 36.42
- lane code facts 24h: 497464 -> 510988
- lane crew facts 24h: 64121 -> 67234
- lane data-ml facts 24h: 55930 -> 58454
- lane hermes-v2 facts 24h: 9804 -> 9835
- lane portal facts 24h: 26092 -> 26141
- lane science facts 24h: 20701 -> 20875
...
|---|---:|---:|---|---|
| code | 510,988 | 0 | GAP | ships, ci_runs, ci_reach, bundle_push, estate_push, worktree_cleanup, hook_outcomes, close_guard, dora |
| crew | 67,234 | 0 | GAP | board, ledger, decisions, directives, tickets, goal_net, attention, founder_actions, board_deadletter, prompt_ledger |
| data-ml | 58,454 | 0 | GAP | dagster-ticks, dagster-runs, temporal_dev_executions, job_timelines |
| hermes-v2 | 9,835 | 0 | GAP | alerts_inbox, sovereign_receipts, sovereign_budget, revenue, agent_cert, runaway-reaper, stuck_detector, aiden_ticks |
| portal | 26,141 | 0 | GAP | estate_registry, capability_receipts, enforcement_map, drills, drills_scripts |
| science | 20,875 | 0 | GAP | research_ledger, predictions, method_metrics, history, spend |
...
- checkpoints 0 for every lane: no `- [x]` line in a ledger written in the last 24h (searched science/RESEARCH-LEDGER.jsonl, science/ships.jsonl, science/attention.jsonl, science/predictions.jsonl; fresh: science/ships.jsonl, science/attention.jsonl)

## Warehouse

`sqlite3 science/warehouse.db "select count(*), count(distinct source), max(ingested_at) from facts"`

- 693,616 rows across 43 sources; last ingest 2026-09-02T18:37:58+00:00
- 44 of 44 declared sources carry owner, method, retention and sensitivity
- stale past their SLA: aiden_ticks (145h), stuck_detector (156h), predictions (78h), job_timelines (90h), estate_push (124h), drills_scripts (157h), sovereign_receipts (183h), board_deadletter (171h), estate_registry (193h), ci_runs (160h), lane.code.pr-hygiene (149h), hindsight_recall (130h)
...
- last 7 days: 254 commits across 4 repos
- founder messages 6123, complaints 342 (5.6%)
- spend USD 9250.05, USD per commit 36.42
...
- 23 recorded before a repair, 9 scored after, hit rate 44%

## Foresight: will this PR go red?

`python3 science/foresight.py report`

- trained 2026-09-02T19:02Z on 2130 labelled PRs; 35% of first runs were red
- unseen newest 426 PRs: accuracy 69% against a base rate of 59%; Brier 0.183
- model beats the base rate on unseen PRs
- strongest signals: log_files (+0.50), r_crew (+0.48), r_prospector (-0.36), log_add (+0.26), f_test (+0.23)
- live: 21 open PRs predicted before their CI finished, 7 scored, hit rate 43%
