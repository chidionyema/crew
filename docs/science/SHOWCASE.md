...
Generated 2026-08-27T00:23Z by `python3 science/showcase.py`. Every number is read at generation
...
- stale past their SLA: toolguard (80h), consult (80h), predictions (72h), worktree_cleanup (83h)

## Data map (LAW 50)

`python3 science/datamap.py --check`

- 67 register entries (COLLECTED 10, EXCLUDED 7, NEVER_EMITTED 13, WIRED_NEVER 37); 8191 producers discovered at the last census
...
- last 7 days: 927 commits across 5 repos
- founder messages 3082, complaints 162 (5.3%)
- spend USD 6602.54, USD per commit 7.12
