...
Regenerated 2026-09-08T05:42:07Z by science/velocity.py from `estate_board.py rank --top 60`.
...
```
finish-first rank, 361 unclaimed of 381 open (2026-09-08T05:42:29Z)
  #16   8/9      lane:platform        cf-bootstrap v2: zero-friction new user setup
  #284  6/7      lane:agents          KINI master spec: from tested package to operational — 7 che
  #527  4/5   P1 lane:process         The board applies science: lanes, measured velocity, finish-
  #63   6/8      lane:process         Supercharge maestro and The Architect: trustworthy, learning
  #488  3/4      lane:platform        Portability extreme and cost future-proofing: the hydration 
  #720  3/4      lane:unsorted        Founder blueprint: eradicate the GitOps brain-split class (g
