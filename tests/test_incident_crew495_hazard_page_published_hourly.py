"""Incident crew#495 CP2: docs/reference/HAZARDS.md on main was a day stale while risk/REGISTER.jsonl and the
...
def test_incident_crew495_snapshot_publishes_the_hazard_page():
    ...
    assert 'HAZARD_PAGE = "docs/reference/HAZARDS.md"' in text
